export default class LetterService {
    ...
    static getLetterTipByLetterId(id) {
        const tips = [
            ...
            'Amo as fontes perto da sala da presidencia, elas me deixam mais calmas',
            'Gosto de ficar vendo as pessoas cozinhando, tenho uma cadeira no cantinho da cozinha',
            'A sala da presidencia é muito grande, hoje entrei lá escondida, mais tive que fugir quando vi alguém chegando',
